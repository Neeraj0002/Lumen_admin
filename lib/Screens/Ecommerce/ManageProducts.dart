...
class ManageEcommerceProducts extends StatefulWidget {
  @override
  _ManageEcommerceProductsState createState() =>
      _ManageEcommerceProductsState();
}

class _ManageEcommerceProductsState extends State<ManageEcommerceProducts> {
